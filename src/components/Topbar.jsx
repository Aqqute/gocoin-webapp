...
const Topbar = () => {
  ...
  return (
    <header
      className={`hidden md:flex justify-between items-center px-8 py-4 border-b ${borderColor} ${bgColor} transition-colors`}
    >
      {/* Left: Page Title + Search */}
      <div className="flex items-center gap-4 w-1/3">
        {/* <h2 className={`text-lg font-semibold ${textColor}`}>Dashboard</h2> */}
      ...
      <div className="flex items-center gap-6">
        <div className={`rounded-full flex items-center py-1 px-3 text-sm font-medium ${isDark ? "bg-[#2a2a2a]" : "bg-gray-200"}`}>
